            ...
            if (currentGameData != null)
            {
                ...
                foreach (var squares in currentGameData.selectedBoardData.Board)
                {
                    foreach (var squareLetter in squares.Row)
                    {
                        ...
                        // still error instance


                        // if (normalLetterData == null)
                        // {
                        //     Debug.LogError($"AlphabetNormal is missing letter '{squareLetter}'");
                        //     return;
                        // }

                        // if (selectedLetterData == null)
                        // {
                        //     Debug.LogError($"AlphabetHighlighted is missing letter '{squareLetter}'");
                        //     return;
                        // }

                        // if (correctLetterData == null)
                        // {
                        //     Debug.LogError($"AlphabetWrong is missing letter '{squareLetter}'");
                        //     return;
                        // }
